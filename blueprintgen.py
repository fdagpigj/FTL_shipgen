...
def generateBlueprint(all_rooms, layout, variant, layout_string, out_dir, stuff_and_things):
	#do I want to return a string here or just append to file?
	return_string = ""
...
#TODO: these functions are supposed to also do operations on the image
